...
A full-stack internal web platform that supports timetable scheduling, resource management, testing, and administration purposes – built for the St. Catherine's British School Computer Science Department.
...
This project is proprietary software created by **William Alexakis**. All rights reserved.

It is licensed exclusively to the **St Catherine’s British School – Upper School Computer Science Department** for internal departmental use under the terms in the LICENSE file.

No other department, division, institution, or third party is permitted to use, deploy, modify, or redistribute this software without written authorization from the Author.
